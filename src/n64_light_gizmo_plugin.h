...
class N64LightGizmoPlugin : public EditorNode3DGizmoPlugin {
	...
	static constexpr const char *POINT_ICON_PATH = "res://addons/n64_visuals_billboards/icons/OmniLight3D.svg";
	static constexpr const char *DIRECTIONAL_ICON_PATH = "res://addons/n64_visuals_billboards/icons/DirectionalLight3D.svg";
	static constexpr const char *SPOT_ICON_PATH = "res://addons/n64_visuals_billboards/icons/DirectionalLight3D.svg";
	...
	static constexpr const char *SPOT_MATERIAL_NAME = "n64_spot_light_icon";
	static constexpr const char *POINT_LINES_MATERIAL_NAME = "n64_point_light_lines";
	static constexpr const char *DIRECTIONAL_LINES_MATERIAL_NAME = "n64_directional_light_lines";
	static constexpr const char *SPOT_LINES_MATERIAL_NAME = "n64_spot_light_lines";
	static constexpr const char *HANDLE_MATERIAL_NAME = "n64_light_handle";
